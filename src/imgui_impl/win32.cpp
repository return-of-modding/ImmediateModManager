...
{
	return (::GetKeyState(vk) & 0x80'00) != 0;
}
...
static void ImGui_ImplWin32_UpdateGamepads()
{
	...
	MAP_ANALOG(ImGuiKey_GamepadLStickLeft, gamepad.sThumbLX, -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, -32'768);
	MAP_ANALOG(ImGuiKey_GamepadLStickRight, gamepad.sThumbLX, +XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, +32'767);
	MAP_ANALOG(ImGuiKey_GamepadLStickUp, gamepad.sThumbLY, +XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, +32'767);
	MAP_ANALOG(ImGuiKey_GamepadLStickDown, gamepad.sThumbLY, -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, -32'768);
	MAP_ANALOG(ImGuiKey_GamepadRStickLeft, gamepad.sThumbRX, -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, -32'768);
	MAP_ANALOG(ImGuiKey_GamepadRStickRight, gamepad.sThumbRX, +XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, +32'767);
	MAP_ANALOG(ImGuiKey_GamepadRStickUp, gamepad.sThumbRY, +XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, +32'767);
	MAP_ANALOG(ImGuiKey_GamepadRStickDown, gamepad.sThumbRY, -XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE, -32'768);
		#undef MAP_BUTTON
		#undef MAP_ANALOG
...
static ImGuiKey ImGui_ImplWin32_VirtualKeyToImGuiKey(WPARAM wParam)
{
    ...
    // Allow compilation with old Windows SDK. MinGW doesn't have default _WIN32_WINNT/WINVER versions.
		...
		#define DBT_DEVNODES_CHANGED 0x00'07
	#endif
...
static ImGuiMouseSource GetMouseSourceFromMessageExtraInfo()
{
	...
	if ((extra_info & 0xFF'FF'FF'80) == 0xFF'51'57'00)
	{
		return ImGuiMouseSource_Pen;
	}
	if ((extra_info & 0xFF'FF'FF'80) == 0xFF'51'57'80)
	{
...
static BOOL _IsWindowsVersionOrGreater(WORD major, WORD minor, WORD)
{
	...
	#define _IsWindowsVistaOrGreater() \
		_IsWindowsVersionOrGreater(HIBYTE(0x06'00), LOBYTE(0x06'00), 0)                            // _WIN32_WINNT_VISTA
	#define _IsWindows8OrGreater() _IsWindowsVersionOrGreater(HIBYTE(0x06'02), LOBYTE(0x06'02), 0) // _WIN32_WINNT_WIN8
	#define _IsWindows8Point1OrGreater() \
		_IsWindowsVersionOrGreater(HIBYTE(0x06'03), LOBYTE(0x06'03), 0) // _WIN32_WINNT_WINBLUE
	#define _IsWindows10OrGreater() \
		_IsWindowsVersionOrGreater(HIBYTE(0x0A'00), LOBYTE(0x0A'00), 0) // _WIN32_WINNT_WINTHRESHOLD / _WIN32_WINNT_WIN10
...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport* viewport)
{
	...
	vd->Hwnd                        = ::CreateWindowEx(vd->DwExStyle,
                                _T("ImGui Platform"),
                                _T("Untitled"),
